...
function init() {
	...
	var containerWidget1 = JK.makeWidget({text : "分厂", type : TYPE_LABEL});
	var containerWidget2 = JK.makeWidget({id : "filiale", type : TYPE_SELECTBOX});
	var widget = JK.makeContainer(containerWidget1, containerWidget2);
	widgets[widgets.length] = widget;
	
	containerWidget1 = JK.makeWidget({text : "类型", type : TYPE_LABEL});
	containerWidget2 = JK.makeWidget({id : "type", type : TYPE_SELECTBOX, method : "change", cmd : "2|3"});
