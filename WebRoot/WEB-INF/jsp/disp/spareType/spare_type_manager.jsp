...
<fmt:setBundle basename="cn.smeltery.resource.spareType.020600" scope="page" />
...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript" src="js/disp/spareType/spareTypeManager.js"></script>
	</head>
	...
	<body class="contentBody">
		<form name="form1">
			...
			<div id="main" style="margin-top: 10px;width: 900px;">
