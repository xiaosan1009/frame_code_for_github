...
<table width="1113px" border="1" cellspacing="0" cellpadding="0" style="border-bottom-width:0;" class="font14 tableStyle">
  <tr>
	...
	<td width="90" style="border-bottom-width:0;" class="headerColor"><fmt:message key="FS_0010" /><!-- 分厂 --></td>
	<td width="90" style="border-bottom-width:0;" class="headerColor"><fmt:message key="FS_0001" /><!-- 大分类 --></td>
	<td width="90" style="border-bottom-width:0;" class="headerColor"><fmt:message key="FS_0002" /><!-- 小分类 --></td>
	<td width="70" style="border-bottom-width:0;" class="headerColor"><fmt:message key="FS_0003" /><!-- 数量 --></td>
	<td width="80" style="border-bottom-width:0;" class="headerColor"><fmt:message key="FS_0004" /><!-- 单价 --></td>
	<td width="80" style="border-bottom-width:0;" class="headerColor"><fmt:message key="FS_0021" /><!-- 总价 --></td>
	<td width="90" style="border-bottom-width:0;" class="headerColor"><fmt:message key="FS_0005" /><!-- 入库时间 --></td>
	<td width="90" style="border-bottom-width:0;" class="headerColor"><fmt:message key="FS_0011" /><!-- 有效日期 --></td>
...
<div style="max-height: 322px;_height: expression(this.scrollHeight>322?'322px':'auto');width:1130px;overflow:auto;margin: 0;">
	...
	<af:forEachList>
		<tr %{line.alternateColor} %{tr_id.style}>
			...
			<td align="center">
				<input id="outNumber_%{line.index}" style="width:100px" name="outNumber" type="text" />
			</td>
		</tr>
	</af:forEachList>
	</table>
