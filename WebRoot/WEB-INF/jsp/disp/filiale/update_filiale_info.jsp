...
<fmt:setBundle basename="cn.smeltery.resource.filiale.020702" scope="page" />
...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript" src="js/disp/filiale/update_filiale_info.js"></script>
	</head>

	<body class="contentBody">
		<form name="form1">
			<jsp:include page="../../frame/inc_body.jsp" />
			<input type="hidden" name="filialeId" id="filialeId" value="${param.filialeId}">
			<div id="formMain">
