...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript" src="js/disp/turnover/add_spare_turnover.js"></script>
	</head>
	...
	<body class="contentBody">
		<form name="form1">
			...
			<div id="formMain">
				...
				<div class="formTr formMesTr">
					<div class="formMesLeft">
						<span class="formTh"><fmt:message key="FS_0006" /></span>
				...
				<div class="formTr formMesTr">
					<div class="formMesLeft">
						...
						<input class="formTd" id="effectiveDate" name="effectiveDate" type="text" readonly="readonly" />
					</div>
					<div class="formMesRight">
					</div>
				</div>
