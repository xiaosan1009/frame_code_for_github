...
<html xmlns="http://www.w3.org/1999/xhtml">
	<head>
		...
		<script type="text/javascript" src="js/disp/turnover/out_material_turnover.js"></script>
	</head>
			...
			<div id="formMain">
				...
				<div id="searchBar">
					<div id="searchBarLeft">
						...
						<select id="childType" name="childType" class="searchBarWidgetMagin" style="border: 1px solid #f60;">
							<jsp:include page="../../frame/inc_cmb.jsp">
				...
				<div id="list1" class="formBottom" style="text-align: left;width:1030px">
				</div>
				...
				<div class="formTr formMesTr">
					<div class="formMesLeft">
						<span class="formTh"><fmt:message key="FS_0011" /></span>
